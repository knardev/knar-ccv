...
// types
import { SectionInsert, Section } from "@/features/homepage/types/types";
...
export function ImageUploader({ setSections, pageId }: ImageUploaderProps) {
  ...
  const handleFileUpload = useCallback(
      ...
      try {
        ...
        for (const file of Array.from(files)) {
          ...
          if (data.publicUrl && profile?.id) {
            ...
            const newSection: Section[] = await addSections([
              {
                page_id: pageId,
    ...
    [supabase, setSections, profile, pageId]
  );
